...
print('starting..')
dataset_root = '/home/bill/diplwmatiki/datasets/'
train_file = os.path.join(dataset_root, 'iot_dataset_very_small.csv')
test_file = os.path.join(dataset_root, 'iot_dataset_very_small_test.csv')
